...
export default async function CustomPage({ params }: Params) {
    ...
    const pageData = await Page.findOne({ main_character_name: customer }) as HydratedDocument<IPage> || null
    const themeData = await General.findOne({ main_character_name: customer }) as HydratedDocument<IGeneral> || null
  ...
  `
    ...
    return (
        <>
            ...
            <div className="container mx-auto flex h-[70vh] items-center  justify-around flex-wrap gap-4">
